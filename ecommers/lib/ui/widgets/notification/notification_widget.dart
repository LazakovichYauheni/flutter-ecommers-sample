        ...
        Flexible(
            child: RichText(
              text: TextSpan(
                ...
                children: <TextSpan>[
                  TextSpan(text: orderNumberText ,style: Theme.of(context).textTheme.bodyText1.copyWith(color: BrandingColors.primary)),
                  TextSpan(text: ' has ', style: Theme.of(context).textTheme.bodyText2),
                  TextSpan(text: richText, style: Theme.of(context).textTheme.bodyText1)
                ]
              ),
            ),
          ),
